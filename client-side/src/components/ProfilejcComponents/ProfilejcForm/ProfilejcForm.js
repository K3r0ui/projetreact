      ...
      <div class='container mt-5'>
         <Form
            ...
            <Form.Item>
               ...
               <Typography>
                  <pre> Date de naissance: {data.dob ? <>{data.dob}</> : <>No Data</>}</pre>
               </Typography>
               <Typography>
                  <pre> Poids: {data.poid ? <>{data.poid}</> : <>No Data</>}</pre>
               </Typography>
               <Typography>
                  <pre> Taille: {data.taille ? <>{data.taille}</> : <>No Data</>}</pre>
               </Typography>
               <Typography>
                  <pre> Nombre de seances prevu par semaine: {data.nbscweek ? <>{data.nbscweek}</> : <>No Data</>}</pre>
               </Typography>
               {/* {
