...
const config = {
   headers: {
      ...
      'x-auth-token':
         'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYyNGE0NzRmMWZlOTI4ZWUwYmE3ZDNlNyIsImlhdCI6MTY0OTYyMjQwMCwiZXhwIjoxNjQ5NjU4NDAwfQ.OO6A9FeHsiecPPTaPD4PygZ081Nk2kx3O-8vOva_V_g',
   },
};
